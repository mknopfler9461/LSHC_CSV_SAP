...
const flashcardData = [
  ...
  },
  {
    ...
    "cards": [
      { "id": 26, "question": "What is MLPS 2.0 and its relevance to SAP in China?", "answer": "The Multi-Level Protection Scheme; SAP systems in China must be graded and certified (usually Level 3) for cybersecurity." },
      { "id": 27, "question": "How does PIPL affect SAP user data?", "answer": "Personal Information Protection Law; requires explicit consent and strict controls for any PII stored in or transferred from SAP China." },
      { "id": 28, "question": "What is the 'Golden Tax' integration requirement?", "answer": "SAP China must integrate with the government's tax system for fapiao (invoice) issuance and validation." },
      { "id": 29, "question": "What is the NMPA's stance on SAP CSV?", "answer": "The National Medical Products Administration (China's FDA) requires strict CSV for any SAP system used in drug or device manufacturing." },
      { "id": 30, "question": "What is 'Data Localization' for SAP China?", "answer": "Critical business and personal data generated in China must be stored on servers physically located within China." },
      { "id": 31, "question": "Define 'Cross-Border Data Transfer' (CBDT) in SAP.", "answer": "The legal process of moving data from SAP China to a global HQ, requiring a security assessment by the CAC." },
      ...
      { "id": 39, "question": "What is 'De-identification' in SAP China reporting?", "answer": "Removing PII from SAP data before sending it to global dashboards to comply with localization laws." },
      { "id": 40, "question": "What is the 'Cryptographic Law' of China?", "answer": "Requires that SAP systems use government-approved encryption algorithms for data storage and transmission." },
      { "id": 41, "question": "What is a 'Data Protection Impact Assessment' (DPIA)?", "answer": "A mandatory PIPL step to assess risks before processing sensitive data in SAP." },
      { "id": 42, "question": "How does 'NMPA Annex 1' apply to SAP?", "answer": "It provides specific guidelines for computerized systems used in pharmaceutical manufacturing." },
      { "id": 43, "question": "What is the 'Cybersecurity Review' for SAP PCE in China?", "answer": "A review required if an SAP project involves purchasing critical network products that could affect national security." },
      { "id": 44, "question": "What is 'Localization Validation'?", "answer": "Validating the specific SAP China Add-on or local patches that are not part of the global core." },
      { "id": 45, "question": "What is 'Joint and Several Liability' in PIPL?", "answer": "Both the customer and SAP (if it is a service provider) can be held liable for data breaches in the cloud." },
      { "id": 46, "question": "What is 'Self-Assessment' for data export?", "answer": "The internal review a company must do before asking the government for permission to export SAP data." },
      { "id": 47, "question": "How is 'Audit Trail' compliance checked by NMPA?", "answer": "Inspectors look for un-editable logs of every data entry, modification, and deletion in SAP." },
      { "id": 48, "question": "What is 'Network Security Domain' in MLPS?", "answer": "Structuring the SAP network into zones (Production, DMZ) with validated firewalls between them." },
      { "id": 49, "question": "What is the 'Designated Data Handler'?", "answer": "The specific entity in China legally responsible for the SAP data under PIPL." },
      { "id": 50, "question": "What is 'Standard Contractual Clauses' (SCC) in China?", "answer": "The legal templates provided by the CAC for transferring SAP data out of China." }
    ]
  },
  {
    "category": "S/4HANA Cloud (PCE)",
    "cards": [
      { "id": 51, "question": "How does CSV change for S/4HANA PCE compared to On-Premise?", "answer": "Responsibility shifts from infrastructure management to vendor assessment and managed service oversight." },
      { "id": 52, "question": "What is the impact of SAP's 2-year release cycle on PCE validation?", "answer": "It requires a 'Continuous Validation' strategy to handle frequent updates without disrupting GxP status." },
      { "id": 53, "question": "What is the 'Shared Responsibility Model' in PCE CSV?", "answer": "SAP manages the cloud infrastructure (Qualified), while the customer manages the application and data (Validated)." },
      { "id": 54, "question": "How does 'Automated Regression Testing' support PCE CSV?", "answer": "It allows for rapid verification of GxP processes whenever SAP applies patches or upgrades." },
      ...
      { "id": 62, "question": "What is 'Configuration as Code' in cloud CSV?", "answer": "Treating SAP configurations as auditable data points that can be moved across environments via controlled transports." },
      { "id": 63, "question": "Why is 'Identity Management' (IAM) more critical in PCE?", "answer": "Because the system is accessed over the internet, requiring validated controls for multi-factor authentication and user provisioning." },
      { "id": 64, "question": "What is the role of the 'Qualified Infrastructure' in PCE?", "answer": "It is the foundation (provided by SAP) upon which the customer's validated SAP application sits." },
      { "id": 65, "question": "Does SAP PCE use the V-Model?", "answer": "Yes, but it is often adapted into an 'Agile' V-Model to fit the cloud delivery speed." },
      { "id": 66, "question": "What is 'OQ by SAP'?", "answer": "SAP performs basic functional testing of the standard software, but the customer still must validate their specific configuration." },
      ...
      { "id": 74, "question": "What is 'Tenant Separation' in PCE CSV?", "answer": "Verifying that the customer's GxP data is logically isolated from other customers in the SAP cloud." },
      { "id": 75, "question": "What is 'User Acceptance Testing' (UAT) in PCE?", "answer": "The final stage where business users confirm the cloud system supports their GxP processes in the real world." }
    ]
  },
  {
  "category": "Architecture & Tools",
    "cards": [
      ...
      { "id": 78, "question": "How does GLP (Laboratory) manifest in SAP?", "answer": "Through integration between the QM module and external LIMS (Lab Systems)." },
      { "id": 79, "question": "What is the regulatory status of EU Annex 11 vs FDA Part 11?", "answer": "Part 11 is binding US law; Annex 11 is EU guidance (though enforced as a standard)." },
      { "id": 80, "question": "What is a GAMP Category 3 system?", "answer": "Non-configured products (COTS) used 'as is' without business-specific configuration." },
      { "id": 81, "question": "What is the focus of 'Interface Validation'?", "answer": "Proving data integrity and mapping accuracy during hand-offs between systems." },
      { "id": 82, "question": "How does Cloud ALM centralize validation deliverables?", "answer": "It links URS, Functional Specs, Test Cases, and the RTM in one digital environment." },
      { "id": 83, "question": "Define the 'Federated Validation' pattern.", "answer": "Maintaining a global validation backbone while adding local annexes for specific regions." },
      { "id": 84, "question": "Name two leading 'Paperless Validation' platforms.", "answer": "Kneat Gx and ValGenesis VLMS." },
      { "id": 85, "question": "What tool identifies affected GxP objects during a patch?", "answer": "LiveCompare or Panaya (Change-Impact Analysis tools)." },
      { "id": 86, "question": "Define the 'Bluefield' migration path.", "answer": "A selective data transition moving chosen processes to S/4HANA, balancing Greenfield and Brownfield." },
      { "id": 87, "question": "What is the 'Clean Core' benefit for CSV?", "answer": "Reduces Cat 5 custom code footprint, simplifying the validation of future upgrades." },
      { "id": 88, "question": "What does 'Enduring' mean in ALCOA+?", "answer": "Ensuring records are readable and exist for the entire required retention period." },
      { "id": 89, "question": "What is the NMPA Annex scope for computerized systems?", "answer": "Broad scope: R&D, Clinical Trials, Manufacturing, and Post-Market." },
      { "id": 90, "question": "What is the 'GTI' validation requirement?", "answer": "Proving accurate export of billing data to the state tax system for legal compliance." },
      { "id": 91, "question": "What is required for MLPS Level 3 certification?", "answer": "Self-assessment plus mandatory annual audits by a certified third-party agency." },
      { "id": 92, "question": "How does expert expertise apply in CSA 'Unscripted Testing'?", "answer": "Testers explore the system to find bugs rather than following a rigid pass/fail script." },
      { "id": 93, "question": "What are 'Delta Requirements'?", "answer": "Business needs not met by SAP Best Practice, requiring custom configuration/code." },
      { "id": 94, "question": "What does the PCE 'QRS' grant the customer?", "answer": "Legal audit rights over SAP's cloud infrastructure and QMS documentation." },
      { "id": 95, "question": "What is 'Continuous Validation'?", "answer": "Using automated regression to keep the system validated through cloud updates." },
      { "id": 96, "question": "Why is 'Traceability' the heart of CSV?", "answer": "It proves every regulatory requirement was designed, built, and successfully tested." },
      { "id": 97, "question": "What is the role of the 'Process Owner'?", "answer": "The individual responsible for the business process and its 'Intended Use' compliance." },
      { "id": 98, "question": "How does China's DSL classify data?", "answer": "Categorizes data based on national security impact to determine protection levels." },
      { "id": 99, "question": "What is 'Data Residency' under PIPL?", "answer": "Storing personal and important data on servers physically located inside China." },
      { "id": 100, "question": "What is the 'V-Model'?", "answer": "Lifecycle model mapping requirement phases (URS/FS) to testing phases (PQ/OQ)." }
    ]
  }
];
...
export default function FlashcardApp() {
  ...
  const count = cat === 'All' ? allCards.length : allCards.filter(c => c.category.includes(cat)).length;
  return (
    <button
      key={cat}
    ...
    >
      ...
      <span className={`ml-2 text-xs font-bold px-1.5 py-0.5 rounded-full ${filter === cat ? 'bg-blue-500 text-white' : 'bg-slate-100 text-slate-500'}`}>{count}</span>
    </button>
  );
})}
          </div>
